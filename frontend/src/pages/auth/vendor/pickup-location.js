...
// Components
import PickupPointeLocation from 'src/sections/auth/vendor/pickup-pointe-location';
...
// Stepper
const steps = ['Pickup pointe location', 'Anticipated rack space usage', 'Contact details', 'Payment details' ];
